...
/**
 * CreateShipmentLabelresponse Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateShipmentLabelresponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateShipmentLabelresponse';
     ...
     * Sets shipmentItems
     *
     * @param string $shipmentItems shipmentItems
     *
     * @return $this
     */
