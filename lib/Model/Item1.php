 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Item1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Item1';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lineItemKey'] === null) {
            $invalidProperties[] = "'lineItemKey' can't be null";
        }
