<?php
/**
 * ListOrderswOparametersresponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ListOrderswOparametersresponse Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListOrderswOparametersresponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListOrdersw/oparametersresponse';
    ...
    protected static $swaggerTypes = [
        'orders' => '\ShipStation\Model\Order[]',
        'total' => 'int',
        'page' => 'int',
        'pages' => 'int'
    ];
     ...
     * Gets orders
     *
     * @return \ShipStation\Model\Order[]
     */
     ...
     * Sets orders
     *
     * @param \ShipStation\Model\Order[] $orders orders
     *
     * @return $this
     */
