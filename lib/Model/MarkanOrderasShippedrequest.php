...
/**
 * MarkanOrderasShippedrequest Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MarkanOrderasShippedrequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MarkanOrderasShippedrequest';
    ...
    protected static $setters = [
        ...
        'notifyCustomer' => 'setNotifyCustomer',
        'notifySalesChannel' => 'setNotifySalesChannel'
    ];
    ...
    protected static $getters = [
        ...
        'notifyCustomer' => 'getNotifyCustomer',
        'notifySalesChannel' => 'getNotifySalesChannel'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['notifyCustomer'] = isset($data['notifyCustomer']) ? $data['notifyCustomer'] : null;
        $this->container['notifySalesChannel'] = isset($data['notifySalesChannel']) ? $data['notifySalesChannel'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['notifyCustomer'] === null) {
            $invalidProperties[] = "'notifyCustomer' can't be null";
        }
        if ($this->container['notifySalesChannel'] === null) {
            $invalidProperties[] = "'notifySalesChannel' can't be null";
        }
    ...
    {
        return $this->container['notifyCustomer'];
    }

    /**
     * Sets notifyCustomer
     *
     * @param bool $notifyCustomer notifyCustomer
     *
     * @return $this
     */
    public function setNotifyCustomer($notifyCustomer)
    {
        $this->container['notifyCustomer'] = $notifyCustomer;

        return $this;
    }

    /**
     * Gets notifySalesChannel
     *
     * @return bool
     */
    public function getNotifySalesChannel()
    {
        return $this->container['notifySalesChannel'];
    }

    /**
     * Sets notifySalesChannel
     *
     * @param bool $notifySalesChannel notifySalesChannel
     *
     * @return $this
     */
    public function setNotifySalesChannel($notifySalesChannel)
    {
        $this->container['notifySalesChannel'] = $notifySalesChannel;
