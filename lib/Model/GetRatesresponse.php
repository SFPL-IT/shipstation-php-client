...
class GetRatesresponse implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['otherCost'] = isset($data['otherCost']) ? $data['otherCost'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['otherCost'] === null) {
            $invalidProperties[] = "'otherCost' can't be null";
        }
    ...
    {
        return $this->container['otherCost'];
    }

    /**
     * Sets otherCost
     *
     * @param double $otherCost otherCost
     *
     * @return $this
     */
    public function setOtherCost($otherCost)
    {
        $this->container['otherCost'] = $otherCost;
