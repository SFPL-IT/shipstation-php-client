 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StatusMapping implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StatusMapping';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['statusKey'] = isset($data['statusKey']) ? $data['statusKey'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['statusKey'] === null) {
            $invalidProperties[] = "'statusKey' can't be null";
        }
    ...
    {
        return $this->container['statusKey'];
    }

    /**
     * Sets statusKey
     *
     * @param string $statusKey statusKey
     *
     * @return $this
     */
    public function setStatusKey($statusKey)
    {
        $this->container['statusKey'] = $statusKey;
