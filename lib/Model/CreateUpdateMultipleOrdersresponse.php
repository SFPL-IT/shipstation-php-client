<?php
/**
 * CreateUpdateMultipleOrdersresponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CreateUpdateMultipleOrdersresponse Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateUpdateMultipleOrdersresponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Create/UpdateMultipleOrdersresponse';
    ...
    protected static $swaggerTypes = [
        'hasErrors' => 'bool',
        'results' => '\ShipStation\Model\Result[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hasErrors'] === null) {
            $invalidProperties[] = "'hasErrors' can't be null";
        }
     ...
     * Sets hasErrors
     *
     * @param bool $hasErrors hasErrors
     *
     * @return $this
     */
     ...
     * Gets results
     *
     * @return \ShipStation\Model\Result[]
     */
     ...
     * Sets results
     *
     * @param \ShipStation\Model\Result[] $results results
     *
     * @return $this
     */
