...
/**
 * InsuranceOptions4 Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InsuranceOptions4 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InsuranceOptions4';
    ...
    protected static $setters = [
        ...
        'insureShipment' => 'setInsureShipment',
    ...
    protected static $getters = [
        ...
        'insureShipment' => 'getInsureShipment',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['insureShipment'] = isset($data['insureShipment']) ? $data['insureShipment'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['insureShipment'] === null) {
            $invalidProperties[] = "'insureShipment' can't be null";
        }
    ...
    {
        return $this->container['insureShipment'];
    }

    /**
     * Sets insureShipment
     *
     * @param bool $insureShipment insureShipment
     *
     * @return $this
     */
    public function setInsureShipment($insureShipment)
    {
        $this->container['insureShipment'] = $insureShipment;
     ...
     * Sets insuredValue
     *
     * @param int $insuredValue insuredValue
     *
     * @return $this
     */
