...
class CustomsItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        'customsItemId' => 'setCustomsItemId',
        'description' => 'setDescription',
        'quantity' => 'setQuantity',
        'value' => 'setValue',
        'harmonizedTariffCode' => 'setHarmonizedTariffCode',
    ...
    protected static $getters = [
        'customsItemId' => 'getCustomsItemId',
        'description' => 'getDescription',
        'quantity' => 'getQuantity',
        'value' => 'getValue',
        'harmonizedTariffCode' => 'getHarmonizedTariffCode',
    ...
    {
        $this->container['customsItemId'] = isset($data['customsItemId']) ? $data['customsItemId'] : null;
        $this->container['description'] = isset($data['description']) ? $data['description'] : null;
        $this->container['quantity'] = isset($data['quantity']) ? $data['quantity'] : null;
        $this->container['value'] = isset($data['value']) ? $data['value'] : null;
        $this->container['harmonizedTariffCode'] = isset($data['harmonizedTariffCode']) ? $data['harmonizedTariffCode'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customsItemId'] === null) {
            $invalidProperties[] = "'customsItemId' can't be null";
        }
    ...
    {
        return $this->container['customsItemId'];
    }

    /**
     * Sets customsItemId
     *
     * @param int $customsItemId customsItemId
     *
     * @return $this
     */
    public function setCustomsItemId($customsItemId)
    {
        $this->container['customsItemId'] = $customsItemId;
    ...
    /**
     * Gets harmonizedTariffCode
     *
     * @return string
     */
    public function getHarmonizedTariffCode()
    {
        return $this->container['harmonizedTariffCode'];
    }

    /**
     * Sets harmonizedTariffCode
     *
     * @param string $harmonizedTariffCode harmonizedTariffCode
     *
     * @return $this
     */
    public function setHarmonizedTariffCode($harmonizedTariffCode)
    {
        $this->container['harmonizedTariffCode'] = $harmonizedTariffCode;
