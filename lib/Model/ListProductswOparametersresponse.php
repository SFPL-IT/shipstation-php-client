<?php
/**
 * ListProductswOparametersresponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ListProductswOparametersresponse Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListProductswOparametersresponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListProductsw/oparametersresponse';
    ...
    protected static $swaggerTypes = [
        'products' => '\ShipStation\Model\Product[]',
        'total' => 'int',
        'page' => 'int',
        'pages' => 'int'
    ];
     ...
     * Gets products
     *
     * @return \ShipStation\Model\Product[]
     */
     ...
     * Sets products
     *
     * @param \ShipStation\Model\Product[] $products products
     *
     * @return $this
     */
