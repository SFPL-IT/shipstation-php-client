...
/**
 * CreateWarehouseresponse Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateWarehouseresponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateWarehouseresponse';
    ...
    protected static $swaggerTypes = [
        ...
        'originAddress' => '\ShipStation\Model\OriginAddress4',
        'returnAddress' => '\ShipStation\Model\ReturnAddress3',
        'createDate' => 'string',
        'isDefault' => 'bool'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['warehouseName'] = isset($data['warehouseName']) ? $data['warehouseName'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['warehouseName'] === null) {
            $invalidProperties[] = "'warehouseName' can't be null";
        }
    ...
    {
        return $this->container['warehouseName'];
    }

    /**
     * Sets warehouseName
     *
     * @param string $warehouseName warehouseName
     *
     * @return $this
     */
    public function setWarehouseName($warehouseName)
    {
        $this->container['warehouseName'] = $warehouseName;
     ...
     * Gets originAddress
     *
     * @return \ShipStation\Model\OriginAddress4
     */
     ...
     * Sets originAddress
     *
     * @param \ShipStation\Model\OriginAddress4 $originAddress originAddress
     *
     * @return $this
     */
     ...
     * Gets returnAddress
     *
     * @return \ShipStation\Model\ReturnAddress3
     */
     ...
     * Sets returnAddress
     *
     * @param \ShipStation\Model\ReturnAddress3 $returnAddress returnAddress
     *
     * @return $this
     */
