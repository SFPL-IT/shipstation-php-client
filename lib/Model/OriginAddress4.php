...
/**
 * OriginAddress4 Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OriginAddress4 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OriginAddress4';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['street3'] === null) {
            $invalidProperties[] = "'street3' can't be null";
        }
