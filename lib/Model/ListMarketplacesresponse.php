...
/**
 * ListMarketplacesresponse Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListMarketplacesresponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListMarketplacesresponse';
    ...
    protected static $swaggerFormats = [
        ...
        'marketplaceId' => 'int32',
        'canRefresh' => null,
        'supportsCustomMappings' => null,
        'supportsCustomStatuses' => null,
        'canConfirmShipments' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'supportsCustomMappings' => 'supportsCustomMappings',
        'supportsCustomStatuses' => 'supportsCustomStatuses',
        'canConfirmShipments' => 'canConfirmShipments'
    ];
    ...
    protected static $setters = [
        ...
        'canRefresh' => 'setCanRefresh',
        'supportsCustomMappings' => 'setSupportsCustomMappings',
        'supportsCustomStatuses' => 'setSupportsCustomStatuses',
        'canConfirmShipments' => 'setCanConfirmShipments'
    ];
    ...
    protected static $getters = [
        ...
        'canRefresh' => 'getCanRefresh',
        'supportsCustomMappings' => 'getSupportsCustomMappings',
        'supportsCustomStatuses' => 'getSupportsCustomStatuses',
        'canConfirmShipments' => 'getCanConfirmShipments'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['canRefresh'] = isset($data['canRefresh']) ? $data['canRefresh'] : null;
        $this->container['supportsCustomMappings'] = isset($data['supportsCustomMappings']) ? $data['supportsCustomMappings'] : null;
        $this->container['supportsCustomStatuses'] = isset($data['supportsCustomStatuses']) ? $data['supportsCustomStatuses'] : null;
        $this->container['canConfirmShipments'] = isset($data['canConfirmShipments']) ? $data['canConfirmShipments'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['canRefresh'] === null) {
            $invalidProperties[] = "'canRefresh' can't be null";
        }
        if ($this->container['supportsCustomMappings'] === null) {
            $invalidProperties[] = "'supportsCustomMappings' can't be null";
        }
        if ($this->container['supportsCustomStatuses'] === null) {
            $invalidProperties[] = "'supportsCustomStatuses' can't be null";
        }
        if ($this->container['canConfirmShipments'] === null) {
            $invalidProperties[] = "'canConfirmShipments' can't be null";
        }
    ...
    {
        return $this->container['canRefresh'];
    }

    /**
     * Sets canRefresh
     *
     * @param bool $canRefresh canRefresh
     *
     * @return $this
     */
    public function setCanRefresh($canRefresh)
    {
        $this->container['canRefresh'] = $canRefresh;

        return $this;
    }

    /**
     * Gets supportsCustomMappings
     *
     * @return bool
     */
    public function getSupportsCustomMappings()
    {
        return $this->container['supportsCustomMappings'];
    }

    /**
     * Sets supportsCustomMappings
     *
     * @param bool $supportsCustomMappings supportsCustomMappings
     *
     * @return $this
     */
    public function setSupportsCustomMappings($supportsCustomMappings)
    {
        $this->container['supportsCustomMappings'] = $supportsCustomMappings;

        return $this;
    }

    /**
     * Gets supportsCustomStatuses
     *
     * @return bool
     */
    public function getSupportsCustomStatuses()
    {
        return $this->container['supportsCustomStatuses'];
    }

    /**
     * Sets supportsCustomStatuses
     *
     * @param bool $supportsCustomStatuses supportsCustomStatuses
     *
     * @return $this
     */
    public function setSupportsCustomStatuses($supportsCustomStatuses)
    {
        $this->container['supportsCustomStatuses'] = $supportsCustomStatuses;

        return $this;
    }

    /**
     * Gets canConfirmShipments
     *
     * @return bool
     */
    public function getCanConfirmShipments()
    {
        return $this->container['canConfirmShipments'];
    }

    /**
     * Sets canConfirmShipments
     *
     * @param bool $canConfirmShipments canConfirmShipments
     *
     * @return $this
     */
    public function setCanConfirmShipments($canConfirmShipments)
    {
        $this->container['canConfirmShipments'] = $canConfirmShipments;
