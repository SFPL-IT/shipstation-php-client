...
/**
 * HoldOrderUntilrequest Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HoldOrderUntilrequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HoldOrderUntilrequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['holdUntilDate'] === null) {
            $invalidProperties[] = "'holdUntilDate' can't be null";
        }
