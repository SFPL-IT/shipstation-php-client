...
/**
 * GetCarrierresponse Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetCarrierresponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetCarrierresponse';
    ...
    protected static $attributeMap = [
        ...
        'requiresFundedAccount' => 'requiresFundedAccount',
        'balance' => 'balance',
        'nickname' => 'nickname',
    ...
    protected static $setters = [
        ...
        'requiresFundedAccount' => 'setRequiresFundedAccount',
        'balance' => 'setBalance',
        'nickname' => 'setNickname',
        'shippingProviderId' => 'setShippingProviderId',
        'primary' => 'setPrimary'
    ];
    ...
    protected static $getters = [
        ...
        'requiresFundedAccount' => 'getRequiresFundedAccount',
        'balance' => 'getBalance',
        'nickname' => 'getNickname',
        'shippingProviderId' => 'getShippingProviderId',
        'primary' => 'getPrimary'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['requiresFundedAccount'] = isset($data['requiresFundedAccount']) ? $data['requiresFundedAccount'] : null;
        $this->container['balance'] = isset($data['balance']) ? $data['balance'] : null;
        $this->container['nickname'] = isset($data['nickname']) ? $data['nickname'] : null;
        $this->container['shippingProviderId'] = isset($data['shippingProviderId']) ? $data['shippingProviderId'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['requiresFundedAccount'] === null) {
            $invalidProperties[] = "'requiresFundedAccount' can't be null";
        }
        if ($this->container['balance'] === null) {
            $invalidProperties[] = "'balance' can't be null";
        }
        if ($this->container['shippingProviderId'] === null) {
            $invalidProperties[] = "'shippingProviderId' can't be null";
        }
    ...
    /**
     * Gets requiresFundedAccount
     *
     * @return bool
     */
    public function getRequiresFundedAccount()
    {
        return $this->container['requiresFundedAccount'];
    }

    /**
     * Sets requiresFundedAccount
     *
     * @param bool $requiresFundedAccount requiresFundedAccount
     *
     * @return $this
     */
    public function setRequiresFundedAccount($requiresFundedAccount)
    {
        $this->container['requiresFundedAccount'] = $requiresFundedAccount;
    ...
    /**
     * Gets shippingProviderId
     *
     * @return int
     */
    public function getShippingProviderId()
    {
        return $this->container['shippingProviderId'];
    }

    /**
     * Sets shippingProviderId
     *
     * @param int $shippingProviderId shippingProviderId
     *
     * @return $this
     */
    public function setShippingProviderId($shippingProviderId)
    {
        $this->container['shippingProviderId'] = $shippingProviderId;
