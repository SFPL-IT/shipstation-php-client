...
/**
 * CreateUpdateOrderresponse Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateUpdateOrderresponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Create/UpdateOrderresponse';
     ...
     * Gets items
     *
     * @return \ShipStation\Model\Item2[]
     */
     ...
     * Sets items
     *
     * @param \ShipStation\Model\Item2[] $items items
     *
     * @return $this
     */
