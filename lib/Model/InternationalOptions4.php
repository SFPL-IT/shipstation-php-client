...
/**
 * InternationalOptions4 Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InternationalOptions4 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InternationalOptions4';
    ...
    protected static $swaggerTypes = [
        'contents' => 'string',
        'customsItems' => '\ShipStation\Model\CustomsItem[]',
        'nonDelivery' => 'string'
    ];
    ...
    protected static $setters = [
        ...
        'customsItems' => 'setCustomsItems',
        'nonDelivery' => 'setNonDelivery'
    ];
    ...
    protected static $getters = [
        ...
        'customsItems' => 'getCustomsItems',
        'nonDelivery' => 'getNonDelivery'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['customsItems'] = isset($data['customsItems']) ? $data['customsItems'] : null;
        $this->container['nonDelivery'] = isset($data['nonDelivery']) ? $data['nonDelivery'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customsItems'] === null) {
            $invalidProperties[] = "'customsItems' can't be null";
        }
        if ($this->container['nonDelivery'] === null) {
            $invalidProperties[] = "'nonDelivery' can't be null";
        }
     ...
     * Gets customsItems
     *
     * @return \ShipStation\Model\CustomsItem[]
     */
    public function getCustomsItems()
    {
        return $this->container['customsItems'];
    }

    /**
     * Sets customsItems
     *
     * @param \ShipStation\Model\CustomsItem[] $customsItems customsItems
     *
     * @return $this
     */
    public function setCustomsItems($customsItems)
    {
        $this->container['customsItems'] = $customsItems;
    ...
    {
        return $this->container['nonDelivery'];
    }

    /**
     * Sets nonDelivery
     *
     * @param string $nonDelivery nonDelivery
     *
     * @return $this
     */
    public function setNonDelivery($nonDelivery)
    {
        $this->container['nonDelivery'] = $nonDelivery;
