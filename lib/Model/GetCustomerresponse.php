 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetCustomerresponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetCustomerresponse';
    ...
    protected static $swaggerTypes = [
        ...
        'marketplaceUsernames' => '\ShipStation\Model\MarketplaceUsername[]',
    ...
    protected static $attributeMap = [
        ...
        'marketplaceUsernames' => 'marketplaceUsernames',
        'tags' => 'tags'
    ];
    ...
    protected static $setters = [
        ...
        'marketplaceUsernames' => 'setMarketplaceUsernames',
        'tags' => 'setTags'
    ];
    ...
    protected static $getters = [
        ...
        'marketplaceUsernames' => 'getMarketplaceUsernames',
        'tags' => 'getTags'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['marketplaceUsernames'] = isset($data['marketplaceUsernames']) ? $data['marketplaceUsernames'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['addressVerified'] === null) {
            $invalidProperties[] = "'addressVerified' can't be null";
        }
        if ($this->container['marketplaceUsernames'] === null) {
            $invalidProperties[] = "'marketplaceUsernames' can't be null";
        }
     ...
     *
     * @param string $addressVerified addressVerified
     *
     * @return $this
     */
    ...
    /**
     * Gets marketplaceUsernames
     *
     * @return \ShipStation\Model\MarketplaceUsername[]
     */
    public function getMarketplaceUsernames()
    {
        return $this->container['marketplaceUsernames'];
    }

    /**
     * Sets marketplaceUsernames
     *
     * @param \ShipStation\Model\MarketplaceUsername[] $marketplaceUsernames marketplaceUsernames
     *
     * @return $this
     */
    public function setMarketplaceUsernames($marketplaceUsernames)
    {
        $this->container['marketplaceUsernames'] = $marketplaceUsernames;
