...
/**
 * ListOrdersbyTagresponse Class Doc Comment
 *
 * @category Class
 * @package  ShipStation
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListOrdersbyTagresponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListOrdersbyTagresponse';
    ...
    protected static $swaggerTypes = [
        'orders' => '\ShipStation\Model\Order2[]',
        'total' => 'int',
        'page' => 'int',
        'pages' => 'int'
    ];
     ...
     * Gets orders
     *
     * @return \ShipStation\Model\Order2[]
     */
     ...
     * Sets orders
     *
     * @param \ShipStation\Model\Order2[] $orders orders
     *
     * @return $this
     */
