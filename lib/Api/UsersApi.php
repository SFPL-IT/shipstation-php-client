...
class UsersApi
{
    ...
    /**
     * Operation usersByShowInactiveGet
     *
     * List Users
     *
     * @param  bool $showInactive Determines whether inactive users will be returned in the response. (optional)
     *
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipStation\Model\ListUsersresponse
     */
    public function usersByShowInactiveGet($showInactive = null)
    {
        list($response) = $this->usersByShowInactiveGetWithHttpInfo($showInactive);
        return $response;
    }

    /**
     * Operation usersByShowInactiveGetWithHttpInfo
     *
     * List Users
     *
     * @param  bool $showInactive Determines whether inactive users will be returned in the response. (optional)
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipStation\Model\ListUsersresponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function usersByShowInactiveGetWithHttpInfo($showInactive = null)
    {
        $returnType = '\ShipStation\Model\ListUsersresponse';
        $request = $this->usersByShowInactiveGetRequest($showInactive);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipStation\Model\ListUsersresponse',
    ...
    /**
     * Operation usersByShowInactiveGetAsync
     *
     * List Users
     *
     * @param  bool $showInactive Determines whether inactive users will be returned in the response. (optional)
     ...
     */
    public function usersByShowInactiveGetAsync($showInactive = null)
    {
        return $this->usersByShowInactiveGetAsyncWithHttpInfo($showInactive)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation usersByShowInactiveGetAsyncWithHttpInfo
     *
     * List Users
     *
     * @param  bool $showInactive Determines whether inactive users will be returned in the response. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersByShowInactiveGetAsyncWithHttpInfo($showInactive = null)
    {
        $returnType = '\ShipStation\Model\ListUsersresponse';
        $request = $this->usersByShowInactiveGetRequest($showInactive);
    ...
    /**
     * Create request for operation 'usersByShowInactiveGet'
     *
     * @param  bool $showInactive Determines whether inactive users will be returned in the response. (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function usersByShowInactiveGetRequest($showInactive = null)
    {
