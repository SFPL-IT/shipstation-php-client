...
class ProductsApi
{
    ...
    /**
     * Operation productsByProductIdGet
     *
     * Get Product
     *
     * @param  double $productId The system generated identifier for the Product. (required)
     *
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipStation\Model\GetProductresponse
     */
    public function productsByProductIdGet($productId)
    {
        list($response) = $this->productsByProductIdGetWithHttpInfo($productId);
        return $response;
    }

    /**
     * Operation productsByProductIdGetWithHttpInfo
     *
     * Get Product
     *
     * @param  double $productId The system generated identifier for the Product. (required)
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipStation\Model\GetProductresponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsByProductIdGetWithHttpInfo($productId)
    {
        $returnType = '\ShipStation\Model\GetProductresponse';
        $request = $this->productsByProductIdGetRequest($productId);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipStation\Model\GetProductresponse',
    ...
    /**
     * Operation productsByProductIdGetAsync
     *
     * Get Product
     *
     * @param  double $productId The system generated identifier for the Product. (required)
     ...
     */
    public function productsByProductIdGetAsync($productId)
    {
        return $this->productsByProductIdGetAsyncWithHttpInfo($productId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productsByProductIdGetAsyncWithHttpInfo
     *
     * Get Product
     *
     * @param  double $productId The system generated identifier for the Product. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsByProductIdGetAsyncWithHttpInfo($productId)
    {
        $returnType = '\ShipStation\Model\GetProductresponse';
        $request = $this->productsByProductIdGetRequest($productId);
    ...
    /**
     * Create request for operation 'productsByProductIdGet'
     *
     * @param  double $productId The system generated identifier for the Product. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function productsByProductIdGetRequest($productId)
    {
        // verify the required parameter 'productId' is set
        if ($productId === null || (is_array($productId) && count($productId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $productId when calling productsByProductIdGet'
            );
        }
    ...
    /**
     * Operation productsByProductIdPut
     *
     * Update Product
     *
     * @param  double $productId The system generated identifier for the Product. (required)
     * @param  string $contentType  (required)
     * @param  \ShipStation\Model\UpdateProductrequest $body  (required)
     *
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipStation\Model\UpdateProductresponse
     */
    public function productsByProductIdPut($productId, $contentType, $body)
    {
        list($response) = $this->productsByProductIdPutWithHttpInfo($productId, $contentType, $body);
        return $response;
    }

    /**
     * Operation productsByProductIdPutWithHttpInfo
     *
     * Update Product
     *
     * @param  double $productId The system generated identifier for the Product. (required)
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipStation\Model\UpdateProductresponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsByProductIdPutWithHttpInfo($productId, $contentType, $body)
    {
        $returnType = '\ShipStation\Model\UpdateProductresponse';
        $request = $this->productsByProductIdPutRequest($productId, $contentType, $body);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipStation\Model\UpdateProductresponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation productsByProductIdPutAsync
     *
     * Update Product
     *
     * @param  double $productId The system generated identifier for the Product. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsByProductIdPutAsync($productId, $contentType, $body)
    {
        return $this->productsByProductIdPutAsyncWithHttpInfo($productId, $contentType, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productsByProductIdPutAsyncWithHttpInfo
     *
     * Update Product
     *
     * @param  double $productId The system generated identifier for the Product. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsByProductIdPutAsyncWithHttpInfo($productId, $contentType, $body)
    {
        $returnType = '\ShipStation\Model\UpdateProductresponse';
        $request = $this->productsByProductIdPutRequest($productId, $contentType, $body);
    ...
    /**
     * Create request for operation 'productsByProductIdPut'
     *
     * @param  double $productId The system generated identifier for the Product. (required)
     * @param  string $contentType  (required)
     * @param  \ShipStation\Model\UpdateProductrequest $body  (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsByProductIdPutRequest($productId, $contentType, $body)
    {
        // verify the required parameter 'productId' is set
        if ($productId === null || (is_array($productId) && count($productId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $productId when calling productsByProductIdPut'
            );
        }
        // verify the required parameter 'contentType' is set
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling productsByProductIdPut'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling productsByProductIdPut'
            );
        }
     ...
     *
     * @param  string $sku Returns products that match the specified SKU. (optional)
     * @param  string $name Returns products that match the specified product name. (optional)
     * @param  string $productCategoryId Returns products that match the specified productCategoryId. (optional)
     * @param  string $productTypeId Returns products that match the specified productTypeId. (optional)
     * @param  string $tagId Returns products that match the specified tagId. (optional)
     * @param  string $startDate Returns products that were created after the specified date. (optional)
     * @param  string $endDate Returns products that were created before the specified date. (optional)
     ...
     * @param  string $showInactive Specifies whether the list should include inactive products. (optional)
     *
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipStation\Model\ListProductswithparametersresponse
     */
    public function productsGet($sku = null, $name = null, $productCategoryId = null, $productTypeId = null, $tagId = null, $startDate = null, $endDate = null, $sortBy = null, $sortDir = null, $page = null, $pageSize = null, $showInactive = null)
    {
        list($response) = $this->productsGetWithHttpInfo($sku, $name, $productCategoryId, $productTypeId, $tagId, $startDate, $endDate, $sortBy, $sortDir, $page, $pageSize, $showInactive);
        return $response;
    }
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipStation\Model\ListProductswithparametersresponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsGetWithHttpInfo($sku = null, $name = null, $productCategoryId = null, $productTypeId = null, $tagId = null, $startDate = null, $endDate = null, $sortBy = null, $sortDir = null, $page = null, $pageSize = null, $showInactive = null)
    {
        $returnType = '\ShipStation\Model\ListProductswithparametersresponse';
        $request = $this->productsGetRequest($sku, $name, $productCategoryId, $productTypeId, $tagId, $startDate, $endDate, $sortBy, $sortDir, $page, $pageSize, $showInactive);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipStation\Model\ListProductswithparametersresponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsGetAsync($sku = null, $name = null, $productCategoryId = null, $productTypeId = null, $tagId = null, $startDate = null, $endDate = null, $sortBy = null, $sortDir = null, $page = null, $pageSize = null, $showInactive = null)
    {
        return $this->productsGetAsyncWithHttpInfo($sku, $name, $productCategoryId, $productTypeId, $tagId, $startDate, $endDate, $sortBy, $sortDir, $page, $pageSize, $showInactive)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsGetAsyncWithHttpInfo($sku = null, $name = null, $productCategoryId = null, $productTypeId = null, $tagId = null, $startDate = null, $endDate = null, $sortBy = null, $sortDir = null, $page = null, $pageSize = null, $showInactive = null)
    {
        $returnType = '\ShipStation\Model\ListProductswithparametersresponse';
        $request = $this->productsGetRequest($sku, $name, $productCategoryId, $productTypeId, $tagId, $startDate, $endDate, $sortBy, $sortDir, $page, $pageSize, $showInactive);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsGetRequest($sku = null, $name = null, $productCategoryId = null, $productTypeId = null, $tagId = null, $startDate = null, $endDate = null, $sortBy = null, $sortDir = null, $page = null, $pageSize = null, $showInactive = null)
    {
        ...
        if ($productCategoryId !== null) {
            $queryParams['productCategoryId'] = ObjectSerializer::toQueryValue($productCategoryId);
        }
        // query params
        if ($productTypeId !== null) {
            $queryParams['productTypeId'] = ObjectSerializer::toQueryValue($productTypeId);
        }
        // query params
        if ($tagId !== null) {
