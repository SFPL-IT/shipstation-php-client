...
class FulfillmentsApi
{
    ...
    /**
     * Operation fulfillmentsGet
     *
     * List Fulfillments with parameters
     *
     * @param  double $fulfillmentId Returns the fulfillment with the specified fulfillment ID. (optional)
     * @param  double $orderId Returns fulfillments whose orders have the specified order ID. (optional)
     * @param  string $orderNumber Returns fulfillments whose orders have the specified order number. (optional)
     * @param  string $trackingNumber Returns fulfillments with the specified tracking number. (optional)
     * @param  string $recipientName Returns fulfillments shipped to the specified recipient name. (optional)
     * @param  string $createDateStart Returns fulfillments created on or after the specified &#x60;&#x60;createDate&#x60;&#x60; (optional)
     * @param  string $createDateEnd Returns fulfillments created on or before the specified &#x60;&#x60;createDate&#x60;&#x60; (optional)
     * @param  string $shipDateStart Returns fulfillments with the &#x60;&#x60;shipDate&#x60;&#x60; on or after the specified date (optional)
     * @param  string $shipDateEnd Returns fulfillments with the &#x60;&#x60;shipDate&#x60;&#x60; on or before the specified date (optional)
     ...
     * @return \ShipStation\Model\ListFulfillmentswithparametersresponse
     */
    public function fulfillmentsGet($fulfillmentId = null, $orderId = null, $orderNumber = null, $trackingNumber = null, $recipientName = null, $createDateStart = null, $createDateEnd = null, $shipDateStart = null, $shipDateEnd = null, $sortBy = null, $sortDir = null, $page = null, $pageSize = null)
    {
        list($response) = $this->fulfillmentsGetWithHttpInfo($fulfillmentId, $orderId, $orderNumber, $trackingNumber, $recipientName, $createDateStart, $createDateEnd, $shipDateStart, $shipDateEnd, $sortBy, $sortDir, $page, $pageSize);
        return $response;
    }

    /**
     * Operation fulfillmentsGetWithHttpInfo
     *
     * List Fulfillments with parameters
     *
     * @param  double $fulfillmentId Returns the fulfillment with the specified fulfillment ID. (optional)
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipStation\Model\ListFulfillmentswithparametersresponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function fulfillmentsGetWithHttpInfo($fulfillmentId = null, $orderId = null, $orderNumber = null, $trackingNumber = null, $recipientName = null, $createDateStart = null, $createDateEnd = null, $shipDateStart = null, $shipDateEnd = null, $sortBy = null, $sortDir = null, $page = null, $pageSize = null)
    {
        $returnType = '\ShipStation\Model\ListFulfillmentswithparametersresponse';
        $request = $this->fulfillmentsGetRequest($fulfillmentId, $orderId, $orderNumber, $trackingNumber, $recipientName, $createDateStart, $createDateEnd, $shipDateStart, $shipDateEnd, $sortBy, $sortDir, $page, $pageSize);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipStation\Model\ListFulfillmentswithparametersresponse',
    ...
    /**
     * Operation fulfillmentsGetAsync
     *
     * List Fulfillments with parameters
     *
     * @param  double $fulfillmentId Returns the fulfillment with the specified fulfillment ID. (optional)
     ...
     */
    public function fulfillmentsGetAsync($fulfillmentId = null, $orderId = null, $orderNumber = null, $trackingNumber = null, $recipientName = null, $createDateStart = null, $createDateEnd = null, $shipDateStart = null, $shipDateEnd = null, $sortBy = null, $sortDir = null, $page = null, $pageSize = null)
    {
        return $this->fulfillmentsGetAsyncWithHttpInfo($fulfillmentId, $orderId, $orderNumber, $trackingNumber, $recipientName, $createDateStart, $createDateEnd, $shipDateStart, $shipDateEnd, $sortBy, $sortDir, $page, $pageSize)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation fulfillmentsGetAsyncWithHttpInfo
     *
     * List Fulfillments with parameters
     *
     * @param  double $fulfillmentId Returns the fulfillment with the specified fulfillment ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fulfillmentsGetAsyncWithHttpInfo($fulfillmentId = null, $orderId = null, $orderNumber = null, $trackingNumber = null, $recipientName = null, $createDateStart = null, $createDateEnd = null, $shipDateStart = null, $shipDateEnd = null, $sortBy = null, $sortDir = null, $page = null, $pageSize = null)
    {
        $returnType = '\ShipStation\Model\ListFulfillmentswithparametersresponse';
        $request = $this->fulfillmentsGetRequest($fulfillmentId, $orderId, $orderNumber, $trackingNumber, $recipientName, $createDateStart, $createDateEnd, $shipDateStart, $shipDateEnd, $sortBy, $sortDir, $page, $pageSize);
    ...
    /**
     * Create request for operation 'fulfillmentsGet'
     *
     * @param  double $fulfillmentId Returns the fulfillment with the specified fulfillment ID. (optional)
     * @param  double $orderId Returns fulfillments whose orders have the specified order ID. (optional)
     * @param  string $orderNumber Returns fulfillments whose orders have the specified order number. (optional)
     ...
     */
    protected function fulfillmentsGetRequest($fulfillmentId = null, $orderId = null, $orderNumber = null, $trackingNumber = null, $recipientName = null, $createDateStart = null, $createDateEnd = null, $shipDateStart = null, $shipDateEnd = null, $sortBy = null, $sortDir = null, $page = null, $pageSize = null)
    {
        ...
        if ($fulfillmentId !== null) {
            $queryParams['fulfillmentId'] = ObjectSerializer::toQueryValue($fulfillmentId);
        }
        // query params
        if ($orderId !== null) {
