...
class AccountsApi
{
     ...
     * @return \ShipStation\Model\ListTagsresponse[]
     */
    public function accountsListtagsGet()
    {
        list($response) = $this->accountsListtagsGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation accountsListtagsGetWithHttpInfo
     *
     * List Tags
     *
     *
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipStation\Model\ListTagsresponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function accountsListtagsGetWithHttpInfo()
    {
        $returnType = '\ShipStation\Model\ListTagsresponse[]';
        $request = $this->accountsListtagsGetRequest();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipStation\Model\ListTagsresponse[]',
    ...
    /**
     * Operation accountsListtagsGetAsync
     *
     * List Tags
     *
     *
     ...
     */
    public function accountsListtagsGetAsync()
    {
        return $this->accountsListtagsGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation accountsListtagsGetAsyncWithHttpInfo
     *
     * List Tags
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountsListtagsGetAsyncWithHttpInfo()
    {
        $returnType = '\ShipStation\Model\ListTagsresponse[]';
        $request = $this->accountsListtagsGetRequest();
    ...
    /**
     * Create request for operation 'accountsListtagsGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function accountsListtagsGetRequest()
    {

        $resourcePath = '/accounts/listtags';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation accountsRegisteraccountPost
     *
     * Register Account
     *
     * @param  string $contentType  (required)
     * @param  \ShipStation\Model\RegisterAccountrequest $body  (required)
     *
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipStation\Model\RegisterAccountresponse
     */
    public function accountsRegisteraccountPost($contentType, $body)
    {
        list($response) = $this->accountsRegisteraccountPostWithHttpInfo($contentType, $body);
        return $response;
    }

    /**
     * Operation accountsRegisteraccountPostWithHttpInfo
     *
     * Register Account
     *
     * @param  string $contentType  (required)
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipStation\Model\RegisterAccountresponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function accountsRegisteraccountPostWithHttpInfo($contentType, $body)
    {
        $returnType = '\ShipStation\Model\RegisterAccountresponse';
        $request = $this->accountsRegisteraccountPostRequest($contentType, $body);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipStation\Model\RegisterAccountresponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation accountsRegisteraccountPostAsync
     *
     * Register Account
     *
     * @param  string $contentType  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountsRegisteraccountPostAsync($contentType, $body)
    {
        return $this->accountsRegisteraccountPostAsyncWithHttpInfo($contentType, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation accountsRegisteraccountPostAsyncWithHttpInfo
     *
     * Register Account
     *
     * @param  string $contentType  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountsRegisteraccountPostAsyncWithHttpInfo($contentType, $body)
    {
        $returnType = '\ShipStation\Model\RegisterAccountresponse';
        $request = $this->accountsRegisteraccountPostRequest($contentType, $body);
    ...
    /**
     * Create request for operation 'accountsRegisteraccountPost'
     *
     * @param  string $contentType  (required)
     * @param  \ShipStation\Model\RegisterAccountrequest $body  (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function accountsRegisteraccountPostRequest($contentType, $body)
    {
        // verify the required parameter 'contentType' is set
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling accountsRegisteraccountPost'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling accountsRegisteraccountPost'
            );
        }

        $resourcePath = '/accounts/registeraccount';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
