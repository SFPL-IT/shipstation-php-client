...
class CarriersApi
{
    ...
    /**
     * Operation carriersAddfundsPost
     *
     * Add Funds
     *
     * @param  \ShipStation\Model\AddFundsrequest $body  (required)
     *
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipStation\Model\AddFundsresponse
     */
    public function carriersAddfundsPost($body)
    {
        list($response) = $this->carriersAddfundsPostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation carriersAddfundsPostWithHttpInfo
     *
     * Add Funds
     *
     * @param  \ShipStation\Model\AddFundsrequest $body  (required)
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipStation\Model\AddFundsresponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function carriersAddfundsPostWithHttpInfo($body)
    {
        $returnType = '\ShipStation\Model\AddFundsresponse';
        $request = $this->carriersAddfundsPostRequest($body);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipStation\Model\AddFundsresponse',
    ...
    /**
     * Operation carriersAddfundsPostAsync
     *
     * Add Funds
     *
     * @param  \ShipStation\Model\AddFundsrequest $body  (required)
     ...
     */
    public function carriersAddfundsPostAsync($body)
    {
        return $this->carriersAddfundsPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation carriersAddfundsPostAsyncWithHttpInfo
     *
     * Add Funds
     *
     * @param  \ShipStation\Model\AddFundsrequest $body  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function carriersAddfundsPostAsyncWithHttpInfo($body)
    {
        $returnType = '\ShipStation\Model\AddFundsresponse';
        $request = $this->carriersAddfundsPostRequest($body);
    ...
    /**
     * Create request for operation 'carriersAddfundsPost'
     *
     * @param  \ShipStation\Model\AddFundsrequest $body  (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function carriersAddfundsPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling carriersAddfundsPost'
            );
        }

        $resourcePath = '/carriers/addfunds';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipStation\Model\ListCarriersresponse[]
     */
    public function carriersGet()
    {
        list($response) = $this->carriersGetWithHttpInfo();
        return $response;
    }
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipStation\Model\ListCarriersresponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function carriersGetWithHttpInfo()
    {
        $returnType = '\ShipStation\Model\ListCarriersresponse[]';
        $request = $this->carriersGetRequest();
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipStation\Model\ListCarriersresponse[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function carriersGetAsync()
    {
        return $this->carriersGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function carriersGetAsyncWithHttpInfo()
    {
        $returnType = '\ShipStation\Model\ListCarriersresponse[]';
        $request = $this->carriersGetRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function carriersGetRequest()
    {
    ...
    /**
     * Operation carriersGetcarrierByCarrierCodeGet
     *
     * Get Carrier
     *
     * @param  string $carrierCode The code for the carrier account to retrieve. (required)
     *
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipStation\Model\GetCarrierresponse
     */
    public function carriersGetcarrierByCarrierCodeGet($carrierCode)
    {
        list($response) = $this->carriersGetcarrierByCarrierCodeGetWithHttpInfo($carrierCode);
        return $response;
    }

    /**
     * Operation carriersGetcarrierByCarrierCodeGetWithHttpInfo
     *
     * Get Carrier
     *
     * @param  string $carrierCode The code for the carrier account to retrieve. (required)
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipStation\Model\GetCarrierresponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function carriersGetcarrierByCarrierCodeGetWithHttpInfo($carrierCode)
    {
        $returnType = '\ShipStation\Model\GetCarrierresponse';
        $request = $this->carriersGetcarrierByCarrierCodeGetRequest($carrierCode);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipStation\Model\GetCarrierresponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation carriersGetcarrierByCarrierCodeGetAsync
     *
     * Get Carrier
     *
     * @param  string $carrierCode The code for the carrier account to retrieve. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function carriersGetcarrierByCarrierCodeGetAsync($carrierCode)
    {
        return $this->carriersGetcarrierByCarrierCodeGetAsyncWithHttpInfo($carrierCode)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation carriersGetcarrierByCarrierCodeGetAsyncWithHttpInfo
     *
     * Get Carrier
     *
     * @param  string $carrierCode The code for the carrier account to retrieve. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function carriersGetcarrierByCarrierCodeGetAsyncWithHttpInfo($carrierCode)
    {
        $returnType = '\ShipStation\Model\GetCarrierresponse';
        $request = $this->carriersGetcarrierByCarrierCodeGetRequest($carrierCode);
    ...
    /**
     * Create request for operation 'carriersGetcarrierByCarrierCodeGet'
     *
     * @param  string $carrierCode The code for the carrier account to retrieve. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function carriersGetcarrierByCarrierCodeGetRequest($carrierCode)
    {
        // verify the required parameter 'carrierCode' is set
        if ($carrierCode === null || (is_array($carrierCode) && count($carrierCode) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $carrierCode when calling carriersGetcarrierByCarrierCodeGet'
            );
        }

        $resourcePath = '/carriers/getcarrier';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation carriersListpackagesByCarrierCodeGet
     *
     * List Packages
     *
     * @param  string $carrierCode The carrier&#39;s code (required)
     *
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipStation\Model\ListPackagesresponse[]
     */
    public function carriersListpackagesByCarrierCodeGet($carrierCode)
    {
        list($response) = $this->carriersListpackagesByCarrierCodeGetWithHttpInfo($carrierCode);
        return $response;
    }

    /**
     * Operation carriersListpackagesByCarrierCodeGetWithHttpInfo
     *
     * List Packages
     *
     * @param  string $carrierCode The carrier&#39;s code (required)
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipStation\Model\ListPackagesresponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function carriersListpackagesByCarrierCodeGetWithHttpInfo($carrierCode)
    {
        $returnType = '\ShipStation\Model\ListPackagesresponse[]';
        $request = $this->carriersListpackagesByCarrierCodeGetRequest($carrierCode);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipStation\Model\ListPackagesresponse[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation carriersListpackagesByCarrierCodeGetAsync
     *
     * List Packages
     *
     * @param  string $carrierCode The carrier&#39;s code (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function carriersListpackagesByCarrierCodeGetAsync($carrierCode)
    {
        return $this->carriersListpackagesByCarrierCodeGetAsyncWithHttpInfo($carrierCode)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation carriersListpackagesByCarrierCodeGetAsyncWithHttpInfo
     *
     * List Packages
     *
     * @param  string $carrierCode The carrier&#39;s code (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function carriersListpackagesByCarrierCodeGetAsyncWithHttpInfo($carrierCode)
    {
        $returnType = '\ShipStation\Model\ListPackagesresponse[]';
        $request = $this->carriersListpackagesByCarrierCodeGetRequest($carrierCode);
    ...
    /**
     * Create request for operation 'carriersListpackagesByCarrierCodeGet'
     *
     * @param  string $carrierCode The carrier&#39;s code (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function carriersListpackagesByCarrierCodeGetRequest($carrierCode)
    {
        // verify the required parameter 'carrierCode' is set
        if ($carrierCode === null || (is_array($carrierCode) && count($carrierCode) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $carrierCode when calling carriersListpackagesByCarrierCodeGet'
            );
        }

        $resourcePath = '/carriers/listpackages';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation carriersListservicesByCarrierCodeGet
     *
     * List Services
     *
     * @param  string $carrierCode The carrier&#39;s code (required)
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipStation\Model\ListServicesresponse[]
     */
    public function carriersListservicesByCarrierCodeGet($carrierCode)
    {
        list($response) = $this->carriersListservicesByCarrierCodeGetWithHttpInfo($carrierCode);
        return $response;
    }

    /**
     * Operation carriersListservicesByCarrierCodeGetWithHttpInfo
     *
     * List Services
     *
     * @param  string $carrierCode The carrier&#39;s code (required)
     ...
     * @throws \ShipStation\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipStation\Model\ListServicesresponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function carriersListservicesByCarrierCodeGetWithHttpInfo($carrierCode)
    {
        $returnType = '\ShipStation\Model\ListServicesresponse[]';
        $request = $this->carriersListservicesByCarrierCodeGetRequest($carrierCode);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipStation\Model\ListServicesresponse[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation carriersListservicesByCarrierCodeGetAsync
     *
     * List Services
     *
     * @param  string $carrierCode The carrier&#39;s code (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function carriersListservicesByCarrierCodeGetAsync($carrierCode)
    {
        return $this->carriersListservicesByCarrierCodeGetAsyncWithHttpInfo($carrierCode)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation carriersListservicesByCarrierCodeGetAsyncWithHttpInfo
     *
     * List Services
     *
     * @param  string $carrierCode The carrier&#39;s code (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function carriersListservicesByCarrierCodeGetAsyncWithHttpInfo($carrierCode)
    {
        $returnType = '\ShipStation\Model\ListServicesresponse[]';
        $request = $this->carriersListservicesByCarrierCodeGetRequest($carrierCode);
    ...
    /**
     * Create request for operation 'carriersListservicesByCarrierCodeGet'
     *
     * @param  string $carrierCode The carrier&#39;s code (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function carriersListservicesByCarrierCodeGetRequest($carrierCode)
    {
        // verify the required parameter 'carrierCode' is set
        if ($carrierCode === null || (is_array($carrierCode) && count($carrierCode) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $carrierCode when calling carriersListservicesByCarrierCodeGet'
            );
        }

        $resourcePath = '/carriers/listservices';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
